...
class _UserInfoScreenState extends State<UserInfoScreen> {
  ...
  void initState() {
    ...
    _emailCtrl = TextEditingController(
      text:
          state.profile?.email?.isNotEmpty == true
              ? state.profile!.email
              : state.auth?.email ?? '',
    );
    _phoneCtrl = TextEditingController(text: state.profile?.phone ?? '');
    _classCtrl = TextEditingController(text: state.profile?.userClass ?? '');
    _schoolCtrl = TextEditingController(text: state.profile?.userSchool ?? '');
